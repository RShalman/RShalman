...
<p>I'm <a href="${config.cfg.portfolioURL}" target="_blank">${config.cfg.name}</a>, ${config.cfg.mainJobTitle} from <b>${config.cfg.from.city}, ${config.cfg.from.country}</b> <img src="${config.cfg.from.flagIconURL}" width="13" alt="${config.cfg.from.country}" />, currently living in <b>${config.cfg.currentlyLiving.city}, ${config.cfg.currentlyLiving.country}</b> <img src="${config.cfg.currentlyLiving.flagIconURL}" width="13" alt="${config.cfg.currentlyLiving.country}" /></p>
